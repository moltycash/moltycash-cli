...
HUMAN SUBCOMMANDS:
  human tip <username> <amount> [--network <base|solana|stellar>]
  human hire <username> "<description>" --amount <USDC> [--network <base|solana|stellar>]

GIG SUBCOMMANDS:
  gig create "<description>" --price <USDC> [--quantity <n>] [--network <base|solana|stellar>] [--min-followers <n>] [--require-premium] [--min-account-age <days>]
...
OPTIONS:
  ...
  --network        Specify network (base, solana, or stellar)
